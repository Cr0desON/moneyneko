    ...
    function custom_homepage_landing_render() {
        ...
        <div class="sketch-landing-wrapper">
            <div class="top-buttons-container">
                <a href="https://moneyneko.ai-info.ru/profile/" class="sketch-btn-profile">Профиль</a>
                <a href="https://moneyneko.ai-info.ru/доска-лидеров/" class="sketch-btn-leaderboard">Доска лидеров</a>
            </div>
            ...
            <div class="sketch-hero-section">
                ...
                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/%d1%82%d0%b2%d0%be%d0%b9-%d0%bf%d0%b5%d1%80%d0%b2%d1%8b%d0%b9-%d1%88%d0%b0%d0%b3-%d0%ba-%d1%84%d0%b8%d0%bd%d0%b0%d0%bd%d1%81%d0%be%d0%b2%d0%be%d0%b9-%d1%81%d0%b2%d0%be%d0%b1%d0%be%d0%b4%d0%b5-2/" class="sketch-btn-start">Начать обучение</a>
            </div>

            <div class="sketch-modules-grid">
                <!-- Модули -->
                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/тема-1-cash-flow-как-отслеживать-притоки-и-отто/" class="sketch-module mod-1">
                    <div class="module-title">Модуль 1.</div>
                    <div class="module-desc">Учет денежных<br>потоков</div>
                    <div class="module-icon">💰</div>
                </a>

                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/тема-1-zero-based-budgeting-бюджет-с-нуля/" class="sketch-module mod-2">
                    <div class="module-title">Модуль 2.</div>
                    <div class="module-desc">Гибкое<br>планирование</div>
                    <div class="module-icon">📅</div>
                </a>

                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/тема-1-ликвидность-способность-отвеча/" class="sketch-module mod-3">
                ...
                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/тема-1-совокупная-стоимость-владения-tco/" class="sketch-module mod-4">
                    <div class="module-title">Модуль 4.</div>
                    <div class="module-desc">Рациональное<br>принятие<br>решений</div>
                    <div class="module-icon">💡</div>
                </a>

                <a href="https://moneyneko.ai-info.ru/courses/moneyneko-full-course/lessons/тема-1-налоговый-вычет-за-обучение-и-ле/" class="sketch-module mod-5">
